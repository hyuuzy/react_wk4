    ...
    return(
        <section className="pt-4 px-3 lg:px-4">
            <div className="border-2 border-white rounded-lg p-4 shadow-lg overflow-hidden">
                ...
                <div className="p-4">
                    <h4 className="text-base text-current font-bold mb-1">
                        {product.title}
                    </h4>
               ...
               border-2 border-sky-400 px-2 py-2 rounded-full hover:bg-sky-400 hover:text-white">
                            See More
                        ...
                        <span className="text-gray-500 inline-flex items-center leading-none text-lg py-1 font-bold">
                            US${product.price}.00
                        </span>
               </div>
                </div>
